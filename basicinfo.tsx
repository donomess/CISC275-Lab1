...
const yourName : String = "Steven Kraus";
let yourPronouns : String = "He/Him";
const yourMajor : String = "Computer Science";
let classification : String = "Sophomore";
let oneExcite : String = "Learning about website creation";
let anyConcerns : String = "The final project";
let funFact : String = "One of my legs is longer than the other";
