...
const yourName : String = "Michael Bocelli";
let yourPronouns : String = "he/him";
const yourMajor : String = "Computer Science";
let classification : String = "junior";
let oneExcite : String = "Learning TypeScript to make cool web applications";
let anyConcerns : String = "Finding partners for the final project";
let funFact : String = "I cna speak German (not that good though)";
