...
const yourName : String = "Jadyn Worthington";
let yourPronouns : String = "Him/He";
const yourMajor : String = "Comp Sci";
let classification : String = "Junior";
let oneExcite : String = "Learning how to build websites and better handling github";
let anyConcerns : String = "git and github with merge conflicts";
let funFact : String = "I like to go to car meets";
