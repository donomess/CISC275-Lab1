...
const yourName : String = "Diya Shah";
let yourPronouns : String = "She/Her";
const yourMajor : String = "Computer Science";
let classification : String = "Sophomore";
let oneExcite : String = "Software Engineering";
let anyConcerns : String = "Understanding all the concepts;
let funFact : String = "I've been to over 10 countries";
